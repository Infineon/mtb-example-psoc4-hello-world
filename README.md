# PSOC&trade; 4: Hello world

This code example demonstrates simple UART communication by printing a "Hello world" message on a terminal and blinks an LED using PSOC&trade; 4.

[View this README on GitHub.](https://github.com/Infineon/mtb-example-psoc4-hello-world)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
This example uses the board's default configuration for all the kits listed above, except the CY8CPROTO-040T, CY8CPROTO-040T-MS and CY8CPROTO-040T-AUTO. To use UART functionality, change the SW2 switch towards UART on the CY8CPROTO-040T, CY8CPROTO-040T-MS and CY8CPROTO-040T-AUTO. See the kit guide to ensure that the board is configured correctly.
...
The following example clones the "[Hello world](https://github.com/Infineon/mtb-example-psoc4-hello-world)" application with the desired name "MyHelloWorld" configured for the *CY8CKIT-041S-MAX* BSP into the specified working directory, *C:/mtb_projects*:
...
| LED (BSP) | CYBSP_USER_LED1 | User LED to show output |
...
Document title: *CE230635* - *PSOC&trade; 4: Hello world*
 ...
 2.8.0   | Added support for CY8CPROTO-040T-AUTO and updated to support ModusToolbox&trade; v3.8
